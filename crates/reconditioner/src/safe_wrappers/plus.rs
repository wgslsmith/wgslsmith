...
pub fn plus(name: String, data_type: &DataType) -> FnDecl {
    let condition = match data_type.as_scalar().unwrap() {
        ...
        ty => unreachable!("no plus wrapper for type {ty}"),
    };
            ...
            |a, b| {
                BinOpExpr::new(
                    ...
                    BinOpExpr::new(
                        BinOp::Greater,
                        a,
                        BinOpExpr::new(BinOp::Minus, Lit::I32(i32::MAX), b),
                    ),
                )
                .into()
            },
            ...
            |a, b| {
                BinOpExpr::new(
                    ...
                    BinOpExpr::new(
                        BinOp::Less,
                        a,
                        BinOpExpr::new(BinOp::Minus, Lit::I32(i32::MIN), b),
                    ),
                )
                .into()
            },
...
fn gen_condition_for_u32(data_type: &DataType) -> ExprNode {
    ...
    BinOpExpr::new(
        ...
        BinOpExpr::new(
            BinOp::Minus,
            TypeConsExpr::new(data_type.clone(), vec![Lit::U32(u32::MAX).into()]),
            VarExpr::new("b").into_node(data_type.clone()),
        ),
    )
    .into()
